...
class __TwigTemplate_d6cf57b37adfc6261bcd6b8b14bdcaca4337e7ef09ca8aadc1ed321a7b6b5404 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <script>
        ...
        if (array_key_exists("currentCategoryId", $context)) {
            ...
            echo twig_escape_filter($this->env, twig_escape_filter($this->env, (isset($context["currentCategoryId"]) || array_key_exists("currentCategoryId", $context) ? $context["currentCategoryId"] : (function () { throw new RuntimeError('Variable "currentCategoryId" does not exist.', 18, $this->source); })()), "js"), "html", null, true);
            echo "';
        ";
        } else {
            // line 20
        ...
        if (array_key_exists("currentProductId", $context)) {
            ...
            echo twig_escape_filter($this->env, twig_escape_filter($this->env, (isset($context["currentProductId"]) || array_key_exists("currentProductId", $context) ? $context["currentProductId"] : (function () { throw new RuntimeError('Variable "currentProductId" does not exist.', 24, $this->source); })()), "js"), "html", null, true);
            echo "';
        ";
        } else {
            // line 26
        ...
        window.categories = ";
        // line 29
        echo $this->extensions['App\Twig\SerializerExtension']->serializeToJsonLd((isset($context["categories"]) || array_key_exists("categories", $context) ? $context["categories"] : (function () { throw new RuntimeError('Variable "categories" does not exist.', 29, $this->source); })()));
        echo ";
    </script>
...
";
    ...
    {
        return array (  162 => 32,  156 => 29,  153 => 28,  149 => 26,  143 => 24,  141 => 23,  138 => 22,  134 => 20,  128 => 18,  126 => 17,  119 => 14,  109 => 13,  97 => 10,  91 => 8,  81 => 7,  70 => 4,  60 => 3,  37 => 1,);
    }
...
{% endblock %}
", "product/index.html.twig", "/var/www/html/vue2/templates/product/index.html.twig");
    }
}
